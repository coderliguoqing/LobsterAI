...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    imExecSecurityLabel: 'IM 渠道命令执行',
    imExecSecurityDeny: '禁止执行',
    imExecSecurityDenyHint: 'IM 渠道不允许执行任何系统命令（默认，最安全）',
    imExecSecurityAskDangerous: '仅危险命令确认',
    imExecSecurityAskDangerousHint: '安全命令自动放行，删除/push 等危险命令通过 IM 询问确认',
    imExecSecurityAsk: '全部命令确认',
    imExecSecurityAskHint: '每次执行前通过 IM 消息询问用户确认（60 秒超时自动拒绝）',
  ...
  en: {
    ...
    imExecSecurityLabel: 'IM Channel Command Execution',
    imExecSecurityDeny: 'Deny All',
    imExecSecurityDenyHint: 'IM channels cannot execute any system commands (default, safest)',
    imExecSecurityAskDangerous: 'Confirm Dangerous Only',
    imExecSecurityAskDangerousHint: 'Auto-approve safe commands; confirm delete/push/kill via IM',
    imExecSecurityAsk: 'Confirm All',
    imExecSecurityAskHint: 'Ask user via IM before every command (60s timeout, auto-deny)',
